...
if __name__ == '__main__':
    ...
    configurations = [
        ...
        ({'cytomine': {'dataset_path': '../datasets/LBTD-NEO04/'}, 'dataset': {'points':True, 'negative_points': True, 'box':True, 'mask_prompt':True}}, 'LBTD-NEO04111'), # check why change dataset path for evaluation ?
    ]
